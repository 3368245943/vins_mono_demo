...
public class JavaCamera {
    ...
    private volatile boolean cameraOpen;
    ...
    private CameraCaptureSession.StateCallback sessionStateCallback = new CameraCaptureSession.StateCallback() {
        ...
        public void onConfigured(CameraCaptureSession session) {
            if (!cameraOpen || camera == null || session.getDevice() != camera || captureBuilder == null) {
                session.close();
                return;
            }
            try {
    ...
    private CameraDevice.StateCallback cameraDeviceStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onDisconnected(CameraDevice camera) {
            if (JavaCamera.this.camera == camera) {
                JavaCamera.this.camera = null;
                cameraOpen = false;
            }
            camera.close();
            if (openCallback != null) {
    ...
    private void startCameraView(CameraDevice camera) throws CameraAccessException {
        ...
        // Use continuous video autofocus so the preview can focus on nearby scenes.
