...
{
public:
    KeyFrame(double _header, int _global_index, Eigen::Vector3d _T_w_c, Eigen::Matrix3d _R_w_c, cv::Mat &_image, const std::string &_brief_pattern_file, const int _segment_index);
