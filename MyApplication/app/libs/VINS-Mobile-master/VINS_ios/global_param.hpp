...
// Camera-to-IMU rotation, configured per device by setGlobalParam().
extern double RIC_y;
extern double RIC_p;
extern double RIC_r;
...
#define GRAVITY ((double)9.81) // 9.805
#define ACC_N ((double)0.2) //0.5 //0.02
...
#define G_NORM ((double)9.81) // 9.805
...
#define timeBenchmarking 1
#if timeBenchmarking
#define TS(name) int64 t_##name = cv::getTickCount()
#define TE(name) __android_log_print(ANDROID_LOG_INFO, "VINS_BENCH", "TIMER_" #name ": %.2fms\n", \
